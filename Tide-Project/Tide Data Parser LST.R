...
#This R markdown contians a script for downloading and analyzing NOAA Tide and Current Bouy data. 
# The "rnoaa" package allows user to retrieve  data from the NOAA API. 

#Kiptopeke station ID 
#8632200
# The code below is pulling data from the Kiptopeke station because it has a complete data record going back to 1980.

#Wachapreague station ID
#8631044
# Because Wachapreague is missing data in 2006 and 2007 it will produce an error and stop the loop, to 
# retrieve all wachapreague data change the data range in the initialization of the for loop to c(1983:2005, 2008:2019)
...
for (i in c(1983:2005, 2008:2019)){
   
   print(paste0("Start: ", i))
   
   new <- coops_search(station_name = 8631044, begin_date = paste0(i,"0101"), 
                       end_date = paste0((i),"1231"), product = "high_low", datum = "STND", time_zone = "lst")
...
# HH and LL signify the higher or lower of the high and low tides.
head(tideData)
...
#This function takes the arguments month, day, and year and returns the percent of tides in the record 
# lower than the tides on the day selected with the arguments.
...
howHighWasTheTide <- function(month,day,year){
   ...
   second <- paste("The second high tide on", month,"/",day,"/",year, "is higher than", secondOutput, "Percent of high tides from 1983 - 2019 at Wachapreague *(2006 and 2007 data missing)")
      
   first <- paste("The first high tide on", month,"/",day,"/",year, "is higher than", firstOutput, "Percent of high tides from 1983 - 2019 at Wachapreague *(2006 and 2007 data missing)")
...
howHighWasTheTide(month = 10, day = 11, year = 2019)
